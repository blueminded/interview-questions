...
describe('NewQuestionComponent', () => {
  ...
  it('Should bring the categories from the question service', () => {
    ...
    inject([HttpTestingController, QuestionService], 
      ...
      const req = httpMock.expectOne(
        req => req.method === 'GET' && req.url === 'https://question-bank-6ffba.firebaseio.com/categories.json');
  ...
  it('Should bring the questions from the question service', () => {
    ...
    inject([HttpTestingController, QuestionService], 
      ...
      const req = httpMock.expectOne(
        req => req.method === 'GET' && req.url === 'https://question-bank-6ffba.firebaseio.com/questions.json');
  ...
  it('Should insert the questions from the question service', () => {
    ...
    inject([HttpTestingController, QuestionService], 
      ...
      const req = httpMock.expectOne(
        req => req.method === 'POST' && req.url === 'https://question-bank-6ffba.firebaseio.com/questions.json');
  ...
  it('Should update the questions from the question service', () => {
    ...
    inject([HttpTestingController, QuestionService], 
      ...
      const req = httpMock.expectOne(
        req => req.method === 'PUT' && req.url === `https://question-bank-6ffba.firebaseio.com/questions/${questionID}.json`);
